...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose, emit }) {
        ...
        const addButtonDisabled = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_6__.computed)(() => !isAppNameValid.value || !isDescriptionValid.value);
        const __returned__ = { validationOptions, executor, props, name, isAppNameValid, isDescriptionValid, description, emit, validations, addOrUpdateApplication, appNameValidationStatus, descriptionValidationStatus, setNameValue, setDescValue, addButtonDisabled, IDEInput: _components_application_IDEInput_vue__WEBPACK_IMPORTED_MODULE_5__["default"] };
