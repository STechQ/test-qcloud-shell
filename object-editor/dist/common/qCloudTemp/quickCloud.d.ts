...
export type ModelType = ContentType | "bpmn" | "process" | "entityDesigner" | "namedComponent" | "flow" | "workflow" | "service" | "step" | "flowEntity" | "appSettings" | "object";
...
export interface IModelForWorkflow {
    modelID: string;
    name: string;
    createDate?: Date;
    updateDate?: number;
