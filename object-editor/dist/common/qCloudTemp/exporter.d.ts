import { IModel, IModule } from "../../ui/src/domain/model/models";
import { IOrganizationCloud } from "../clean/domain/useCases/ICloudProvider";
...
export interface IGetExportModelsRequest {
    type: "named" | "entityDesigner" | "flow" | "flowEntity" | "other";
...
export interface IExportItem {
    id: string;
    ver: string;
    type: "settings_yaml" | "alert_qjson" | "pipeline_qjson" | "localProxy_yaml" | "globalLocalization_qjson" | "loading_qjson" | "componentList_js" | "namedComps" | "qjsons" | "css" | "containerServices_js" | "bpmn" | "process" | "entityDesigner" | "flow" | "assetList_js" | "flowEntity" | "lottie" | "appSettings" | "png" | "jpg" | "jpeg" | "svg" | "gif" | "woff" | "woff2" | "ttf" | "otf";
    size?: number;
    path: string;
    name: string;
    isRootPage?: boolean;
...
export type JobType = "export" | "deploy" | "pack" | "appmanagement" | "organizationManagement";
...
export type AllJobDataTypes = IExportJobData | IServiceExportJobData | IDeployJobData | IBuildJobData | IDeploymentStartJobData | IAppManagementJobData | IOrganizationManagementJobData;
