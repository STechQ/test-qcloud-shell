...
import { IApplication, IFolder, IModel } from "../../ui/src/domain/model/models";
import { IAppCloud } from "../clean/domain/useCases/ICloudProvider";
import { AzureBlobContentType } from "../clean/infrastructure/cloud/azureLow";
...
import { IApplicationDetails, IApplicationExportSettings, IModelBodyObject, IDependentModel, IOrganizationActions, ModelAdditionals, ObjectID, IModuleBackend, IModuleVersion, IModuleRelatedModelItem, ITags, IOrganizationGroup, IModelInfo, ModelType, ExtensionType, UsageType, AppSettingsModelKeys, AllModelAdditionalTypes, IApplication as IApplicationDbModel } from "./quickCloud";
...
export interface IGetModuleResponse extends IModuleBackend {
    versionID?: IModuleVersion["ID"];
    version?: IModuleVersion["version"];
    relatedModelHistories?: IModuleVersion["relatedModelHistories"];
}
export interface IGetModelInformationsRequest {
    models: Array<IModuleRelatedModelItem>;
    outerOrgId?: string;
}
