...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        ...
        function History() {
            executor.execute(async () => {
                var _a, _b;
                await dialog.showDialog(compCreator.createModelHistoriesComponent(), { closable: true, title: (_a = viewModel.studio.currentItem) === null || _a === void 0 ? void 0 : _a.name, closeOnOutClick: true, width: '700px', height: '500px' }, { modelID: (_b = viewModel.studio.currentItem) === null || _b === void 0 ? void 0 : _b.ID });
            }, { loading: true });
        }
        async function Delete() {
            var _a;
        ...
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [
            ...
            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [
                ((_d = $setup.viewModel.studio.currentItem) === null || _d === void 0 ? void 0 : _d.version)
                    ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_13, "Selected Version: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_e = $setup.viewModel.studio.currentItem) === null || _e === void 0 ? void 0 : _e.version), 1 /* TEXT */))
                    : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)
            ])
        ]),
