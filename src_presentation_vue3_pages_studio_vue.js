...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        ...
        const __returned__ = { viewModel, currentItemID, props, tabContainer, showLeftChevron, showRightChevron, wheelHandler, mouseOver, mouseOverActions, showClose, closeTab, selectTab, getTabIcon, isOverFlow, scrollRight, scrollLeft };
        Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
        return __returned__;
    }
}));
