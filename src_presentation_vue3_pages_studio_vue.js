...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        ...
        const __returned__ = { viewModel, executor, studio, notification, dialog, selectionData, router, routerParams, checkedOut, props, tablist, onCheckout, onSave, onSavePlus, onItemSelect, release, listExportjobs, openExportDialog, goMainPage, Tabs: _vue3_components_ui_tabs_vue__WEBPACK_IMPORTED_MODULE_8__["default"] };
        Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
        return __returned__;
    }
}));
