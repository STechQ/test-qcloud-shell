...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        ...
        const __returned__ = { viewModel, sidebarSectionElement, ui, studio, sidebarManager, item, executor, dialog, initialMenu, expandedMenu, closeMenuIcon, expandMenuIcon, onNavItemSelect, openMenu, closeMenu, moveHandler, mousedown, mouseup, collapse, addModule, addScreen, attachModuleToApp, leftpx, openSettings };
        Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
        return __returned__;
    }
}));
