...
export type IModelForWorkflowBase = {
    modelID: string;
    name: string;
    createDate?: Date;
    updateDate?: number;
...
export type IStringModelForWorkflow = IModelForWorkflowBase & {
    type: "qjson";
    modelBody: string;
};
export type IObjectModelForWorkflow = IModelForWorkflowBase & {
    type: Exclude<ModelType, "qjson">;
    modelBody: object;
};
export type IModelForWorkflow = IStringModelForWorkflow | IObjectModelForWorkflow;
