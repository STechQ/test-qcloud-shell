    ...
    setup(__props, { expose }) {
        ...
        function createJob() {
            ...
            deployScreenProps.value.selectedAssets.forEach((module) => {
                ...
                if (module.state.checked) {
                    (_a = module.children) === null || _a === void 0 ? void 0 : _a.forEach((children) => {
                        if (children.state.checked) {
                            deployItems.push({
                                id: children.ID,
                                name: children.name,
        ...
        const __returned__ = { viewModel, modules, currentApp, currentAppItems, applicationAsModuleObject, deployScreenProps, handleNext, handlePrevious, createJob, DeployScreenHeader: _deployScreenHeader_vue__WEBPACK_IMPORTED_MODULE_3__["default"], ModuleSelectionTab: _tabs_moduleSelectionTab_vue__WEBPACK_IMPORTED_MODULE_4__["default"], AssetSelectionTab: _tabs_assetSelectionTab_vue__WEBPACK_IMPORTED_MODULE_5__["default"], SummaryTab: _tabs_summaryTab_vue__WEBPACK_IMPORTED_MODULE_6__["default"] };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [
        ...
        ($setup.deployScreenProps.stepper.step == 3)
            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
                key: 6,
                class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('finish-button-text' + ($setup.deployScreenProps.stepper.isTabValid ? '' : ' text-disabled')),
                onClick: $setup.createJob
            }, " FINISH ", 2 /* CLASS */))
            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true),
        ($setup.deployScreenProps.stepper.step < 3)
