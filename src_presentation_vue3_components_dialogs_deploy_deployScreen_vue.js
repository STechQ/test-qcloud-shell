...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.select-text[data-v-48c390a5] {\n    position: absolute;\n    top: 141px;\n    left: 62px;\n    width: 370px;\n    height: 26px;\n    /* UI Properties */\n    font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) var(--unnamed-font-size-20) / var(--unnamed-line-spacing-26)\n        var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-1);\n    text-align: left;\n    font: normal normal normal 20px/26px Roboto;\n    letter-spacing: 0px;\n    color: #757575;\n    opacity: 1;\n}\n.top-text[data-v-48c390a5] {\n    position: absolute;\n    top: 185px;\n    left: 62px;\n}\n.bold-number[data-v-48c390a5] {\n    font: var(--unnamed-font-style-normal) normal bold var(--unnamed-font-size-20) / var(--unnamed-line-spacing-26) var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-4);\n    text-align: left;\n    font: normal normal bold 20px/26px Roboto;\n    letter-spacing: 0px;\n    color: #212121;\n}\n.top-text-description[data-v-48c390a5] {\n    /* UI Properties */\n    font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) var(--unnamed-font-size-20) / var(--unnamed-line-spacing-26)\n        var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-1);\n    text-align: left;\n    font: normal normal normal 20px/26px Roboto;\n    letter-spacing: 0px;\n    color: #757575;\n}\n.select-modules-checkbox[data-v-48c390a5] {\n    width: 18px;\n    height: 18px;\n    color: #151233;\n    /* UI Properties */\n    border-radius: 50%;\n    opacity: 1;\n}\n.treeviewCard[data-v-48c390a5] {\n    position: absolute;\n    top: 219px;\n    left: 62px;\n    width: 1293px;\n    height: 392px;\n    /* UI Properties */\n    background: var(--white) 0% 0% no-repeat padding-box;\n    border: 1px solid var(--grey-lighten-2);\n    background: #ffffff 0% 0% no-repeat padding-box;\n    border: 1px solid #e0e0e0;\n    opacity: 1;\n    overflow: auto;\n}\n.treeviewCard[data-v-48c390a5]::-webkit-scrollbar {\n  width: 12px;\n}\n.treeviewCard[data-v-48c390a5]::-webkit-scrollbar-track {\n  background: transparent;\n}\n.treeviewCard[data-v-48c390a5]::-webkit-scrollbar-thumb {\n  background-color: #D0D1E9;    \n  border-radius: 16px;\n}\n.icon-position[data-v-48c390a5] {\n    margin-right: -8px;\n    margin-left: 10px;\n}\n.warning-text[data-v-48c390a5] {\n    font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) var(--unnamed-font-size-16) / var(--unnamed-line-spacing-21)\n        var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-4);\n    text-align: left;\n    font: normal normal normal 16px/21px Roboto;\n    letter-spacing: 0px;\n    color: red;\n    opacity: 1;\n}\n", "",{"version":3,"sources":["webpack://./src/presentation/vue3/components/dialogs/deploy/tabs/moduleSelectionTab.vue"],"names":[],"mappings":";AA6HA;IACI,kBAAkB;IAClB,UAAU;IACV,UAAU;IACV,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB;yCACqC;IACrC,kDAAkD;IAClD,2BAA2B;IAC3B,gBAAgB;IAChB,2CAA2C;IAC3C,mBAAmB;IACnB,cAAc;IACd,UAAU;AACd;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,UAAU;AACd;AAEA;IACI,iJAAiJ;IACjJ,kDAAkD;IAClD,2BAA2B;IAC3B,gBAAgB;IAChB,yCAAyC;IACzC,mBAAmB;IACnB,cAAc;AAClB;AAEA;IACI,kBAAkB;IAClB;yCACqC;IACrC,kDAAkD;IAClD,2BAA2B;IAC3B,gBAAgB;IAChB,2CAA2C;IAC3C,mBAAmB;IACnB,cAAc;AAClB;AAEA;IACI,WAAW;IACX,YAAY;IACZ,cAAc;IACd,kBAAkB;IAClB,kBAAkB;IAClB,UAAU;AACd;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,UAAU;IACV,aAAa;IACb,aAAa;IACb,kBAAkB;IAClB,oDAAoD;IACpD,uCAAuC;IACvC,+CAA+C;IAC/C,yBAAyB;IACzB,UAAU;IACV,cAAc;AAClB;AAEA;EACE,WAAW;AACb;AAEA;EACE,uBAAuB;AACzB;AAEA;EACE,yBAAyB;EACzB,mBAAmB;AACrB;AAEA;IACI,kBAAkB;IAClB,iBAAiB;AACrB;AAEA;IACI;yCACqC;IACrC,kDAAkD;IAClD,2BAA2B;IAC3B,gBAAgB;IAChB,2CAA2C;IAC3C,mBAAmB;IACnB,UAAU;IACV,UAAU;AACd","sourcesContent":["<template>\n    <div class=\"select-text\">Select modules to deploy</div>\n    <div class=\"top-text\">\n        <span\n            class=\"select-modules-checkbox mdi mdi-minus-box mdi-24px me-2 mb-1 ms-0\"\n            v-if=\"enabledModules.length === checkedModules.length\"\n            @click=\"setAllCheckStatus(false)\"\n        ></span>\n        <span\n            class=\"select-modules-checkbox mdi mdi-plus-box mdi-24px me-2 mb-1 ms-0\"\n            v-if=\"enabledModules.length !== checkedModules.length\"\n            @click=\"setAllCheckStatus(true)\"\n        ></span>\n        <span class=\"bold-number\">{{ checkedModules.length }}</span>\n        <span class=\"top-text-description\" style=\"color: #616161\"> of </span>\n        <span class=\"bold-number\">{{ items.length }}</span>\n        <span class=\"top-text-description\"> modules selected</span>\n    </div>\n    <div style=\"display: flex\">\n        <div class=\"treeviewCard\">\n            <tree :nodes=\"treeViewNodes\" :config=\"config\" @nodeChecked=\"setSelectedModules\" @nodeUnchecked=\"setSelectedModules\">\n                <template #before-input=\"{ node }\">\n                    <span v-if=\"node.type == 'module'\" :class=\"'mdi mdi-puzzle module-color icon-position' + (node.state.disabled ? ' deploy-screen-disabled-icon' : '')\" />\n                    <span v-else :class=\"'mdi mdi-application module-color icon-position' + (node.state.disabled ? ' deploy-screen-disabled-icon' : '')\" />\n                </template>\n                <template #after-input=\"{ node }\">\n                    <span class=\"warning-text\" v-if=\"node.state.disabled\">(Deploy Settings is not provided!)</span>\n                </template>\n            </tree>\n        </div>\n    </div>\n</template>\n\n<script setup lang=\"ts\">\nimport tree from \"vue3-treeview\";\nimport \"vue3-treeview/dist/style.css\";\nimport { computed, ref } from \"vue\";\nimport { IApplication, IModule } from \"../../../../../../domain/model/models\";\nimport IDeployScreenProps, { ITreeViewNode } from \"../../../../../../domain/presentation/dialogs/IDeployScreenProps\";\n\ninterface IData {\n    deployScreenProps: IDeployScreenProps;\n    items: Array<IModule | IApplication>;\n}\n\ntype ITreeViewData = Record<string, ITreeViewNode>;\nconst props = defineProps<IData>();\nconst items = ref<Array<IModule | IApplication>>(props.items.filter((item) => item.children && !!item.children.length));\nconst roots = items.value.map((item) => item.ID);\nconst treeViewNodes = ref<ITreeViewData>(props.deployScreenProps.moduleSelectionState);\n\nif (!Object.keys(treeViewNodes.value).length) {\n    items.value.forEach((item) => {\n        treeViewNodes.value[item.ID] = {\n            ID: item.ID,\n            text: item.name,\n            name: item.name,\n            type: item.objectType,\n            state: {\n                checked: item.deployParameters ? item.deployParameters.gitServiceRepoId != 0 : false,\n                disabled: item.deployParameters ? item.deployParameters.gitServiceRepoId == 0 : true,\n            },\n            deployParameters: item.deployParameters!\n        };\n    });\n}\n\nconst checkedModules = computed(() =>\n    Object.keys(treeViewNodes.value)\n        .map((key) => treeViewNodes.value[key])\n        .filter((item) => item.state.checked)\n);\n\nconst enabledModules = computed(() =>\n    Object.keys(treeViewNodes.value)\n        .map((key) => treeViewNodes.value[key])\n        .filter((item) => !item.state.disabled)\n);\n\nconst config = ref({\n    roots,\n    checkboxes: true,\n    dragAndDrop: false,\n    editable: false,\n    checkMode: 0,\n    disabledClass: \"deploy-screen-disabled-node\",\n});\n\nfunction setSelectedModules() {\n    props.deployScreenProps.modulesChanged = true;\n    props.deployScreenProps.selectedModules = items.value.filter((item) =>\n        checkedModules.value.some((checkedModule) => checkedModule.ID === item.ID && checkedModule.state.checked)\n    );\n\n    props.deployScreenProps.selectedAssets = props.deployScreenProps.selectedModules.map(\n        (module) =>\n            ({\n                ID: module.ID,\n                name: module.name,\n                text: module.name,\n                type: module.objectType,\n                usageType: undefined,\n                children: module.children,\n                state: { checked: true },\n                version: undefined,\n                deployParameters: module.deployParameters\n            } as ITreeViewNode)\n    );\n\n    props.deployScreenProps.stepper.isTabValid = !!props.deployScreenProps.selectedModules.length;\n}\n\nsetSelectedModules();\n\nfunction setAllCheckStatus(selected: boolean) {\n    Object.keys(treeViewNodes.value).forEach(\n        (key) => (treeViewNodes.value[key].state.checked = selected && !treeViewNodes.value[key].state.disabled)\n    );\n    setSelectedModules();\n}\n</script>\n\n<style scoped>\n@import url(\"../../../../../../styles/IDE3.css\");\n\n.select-text {\n    position: absolute;\n    top: 141px;\n    left: 62px;\n    width: 370px;\n    height: 26px;\n    /* UI Properties */\n    font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) var(--unnamed-font-size-20) / var(--unnamed-line-spacing-26)\n        var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-1);\n    text-align: left;\n    font: normal normal normal 20px/26px Roboto;\n    letter-spacing: 0px;\n    color: #757575;\n    opacity: 1;\n}\n\n.top-text {\n    position: absolute;\n    top: 185px;\n    left: 62px;\n}\n\n.bold-number {\n    font: var(--unnamed-font-style-normal) normal bold var(--unnamed-font-size-20) / var(--unnamed-line-spacing-26) var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-4);\n    text-align: left;\n    font: normal normal bold 20px/26px Roboto;\n    letter-spacing: 0px;\n    color: #212121;\n}\n\n.top-text-description {\n    /* UI Properties */\n    font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) var(--unnamed-font-size-20) / var(--unnamed-line-spacing-26)\n        var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-1);\n    text-align: left;\n    font: normal normal normal 20px/26px Roboto;\n    letter-spacing: 0px;\n    color: #757575;\n}\n\n.select-modules-checkbox {\n    width: 18px;\n    height: 18px;\n    color: #151233;\n    /* UI Properties */\n    border-radius: 50%;\n    opacity: 1;\n}\n\n.treeviewCard {\n    position: absolute;\n    top: 219px;\n    left: 62px;\n    width: 1293px;\n    height: 392px;\n    /* UI Properties */\n    background: var(--white) 0% 0% no-repeat padding-box;\n    border: 1px solid var(--grey-lighten-2);\n    background: #ffffff 0% 0% no-repeat padding-box;\n    border: 1px solid #e0e0e0;\n    opacity: 1;\n    overflow: auto;\n}\n\n.treeviewCard::-webkit-scrollbar {\n  width: 12px;               \n}\n\n.treeviewCard::-webkit-scrollbar-track {\n  background: transparent;        \n}\n\n.treeviewCard::-webkit-scrollbar-thumb {\n  background-color: #D0D1E9;    \n  border-radius: 16px;   \n}\n\n.icon-position {\n    margin-right: -8px;\n    margin-left: 10px;\n}\n\n.warning-text {\n    font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) var(--unnamed-font-size-16) / var(--unnamed-line-spacing-21)\n        var(--unnamed-font-family-roboto);\n    letter-spacing: var(--unnamed-character-spacing-0);\n    color: var(--grey-darken-4);\n    text-align: left;\n    font: normal normal normal 16px/21px Roboto;\n    letter-spacing: 0px;\n    color: red;\n    opacity: 1;\n}\n</style>\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _domain_useCase_IDeployJobs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../domain/useCase/IDeployJobs */ "./src/domain/useCase/IDeployJobs.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose, emit }) {
        ...
        const deployJobsUseCase = _domain_core_diContainer__WEBPACK_IMPORTED_MODULE_1__.container.resolve(_domain_useCase_IDeployJobs__WEBPACK_IMPORTED_MODULE_8__.IDeployJobs);
        const items = viewModel.studio.items.filter((item) => item.objectType == "module");
        const currentApp = viewModel.apps.find((item) => item.ID == viewModel.studio.appId);
        currentApp.children = viewModel.studio.items.filter((item) => item.objectType == "model");
        items.unshift(currentApp);
        ...
        function getTypeOfModel(usageType, type, fileName) {
            if (usageType == "appSettings") {
                switch (fileName) {
                    case "pipeline": return "pipeline_qjson";
                    case "alert": return "alert_qjson";
            ...
            if (type == "qjson")
                return "qjsons";
            if (type == "js")
                return "containerServices_js";
            if (type == "yaml")
                return "settings_yaml";
            if (type == "namedComponent")
                return "namedComps";
            return type;
        }
        function createJob() {
            const deployJobs = Array();
            deployScreenProps.value.selectedAssets.forEach((module) => {
                const deployItems = Array();
                if (module.state.checked) {
                    module.children.forEach((children) => {
                        if (children.type == "module" || children.type == "application" || children.type == "folder")
                            return;
                        if (children.state.checked) {
                            deployItems.push({
                                id: children.ID,
                                name: children.name,
                                type: getTypeOfModel(children.usageType, children.type, children.name),
                                path: "/",
                                ver: children.version,
                            });
                        }
        ...
        const __returned__ = { emit, viewModel, executor, deployJobsUseCase, items, currentApp, deployScreenProps, handleNext, handlePrevious, getTypeOfModel, createJob, DeployScreenHeader: _deployScreenHeader_vue__WEBPACK_IMPORTED_MODULE_3__["default"], ModuleSelectionTab: _tabs_moduleSelectionTab_vue__WEBPACK_IMPORTED_MODULE_4__["default"], AssetSelectionTab: _tabs_assetSelectionTab_vue__WEBPACK_IMPORTED_MODULE_5__["default"], SummaryTab: _tabs_summaryTab_vue__WEBPACK_IMPORTED_MODULE_6__["default"] };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        expose();
        const props = __props;
        const dialog = _domain_core_diContainer__WEBPACK_IMPORTED_MODULE_3__.container.resolve(_domain_presentation_IDialog__WEBPACK_IMPORTED_MODULE_4__.IDialog);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        expose();
        const props = __props;
        const items = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.items.filter((item) => item.children && !!item.children.length));
        const roots = items.value.map((item) => item.ID);
        ...
        const checkedModules = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => Object.keys(treeViewNodes.value)
            .map((key) => treeViewNodes.value[key])
            .filter((item) => item.state.checked));
        const enabledModules = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => Object.keys(treeViewNodes.value)
            .map((key) => treeViewNodes.value[key])
            .filter((item) => !item.state.disabled));
        const config = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)({
            roots,
        ...
        function setSelectedModules() {
            props.deployScreenProps.modulesChanged = true;
            props.deployScreenProps.selectedModules = items.value.filter((item) => checkedModules.value.some((checkedModule) => checkedModule.ID === item.ID && checkedModule.state.checked));
        ...
        function setAllCheckStatus(selected) {
            Object.keys(treeViewNodes.value).forEach((key) => (treeViewNodes.value[key].state.checked = selected && !treeViewNodes.value[key].state.disabled));
            setSelectedModules();
        }
        const __returned__ = { props, items, roots, treeViewNodes, checkedModules, enabledModules, config, setSelectedModules, setAllCheckStatus, tree: vue3_treeview__WEBPACK_IMPORTED_MODULE_1__["default"] };
        Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
        return __returned__;
    }
}));
...
const _hoisted_1 = { class: "deploy-screen-container" };
    ...
    return ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [
        ...
        ($setup.deployScreenProps.stepper.step == 1)
            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["ModuleSelectionTab"], {
                ...
                items: $setup.items
            }, null, 8 /* PROPS */, ["deploy-screen-props", "items"]))
        ...
        ($setup.deployScreenProps.stepper.step == 3)
            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
                ...
                "data-v-33a93b5b": "",
                onClick: $setup.createJob
            }))
            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true),
        ($setup.deployScreenProps.stepper.step == 3)
            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
                key: 6,
                class: "finish-button-text",
                onClick: $setup.createJob
            }, " FINISH "))
            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true),
        ($setup.deployScreenProps.stepper.step < 3)
            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
                key: 7,
                class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('default-button' + ($setup.deployScreenProps.stepper.isTabValid ? '' : ' button-disabled')),
                "data-v-33a93b5b": "",
        ...
        ($setup.deployScreenProps.stepper.step < 3)
            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
                key: 8,
                class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('next-button-text' + ($setup.deployScreenProps.stepper.isTabValid ? '' : ' text-disabled')),
                onClick: $setup.handleNext
            }, " NEXT ", 2 /* CLASS */))
            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)
    ]));
...
const _hoisted_1 = { class: "deploy-screen-header-container" };
const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", { class: "first-number number-active" }, "1", -1 /* HOISTED */));
const _hoisted_3 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", { class: "first-text text-active" }, "Module Selection", -1 /* HOISTED */));
const _hoisted_4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", { class: "first-line line-active" }, null, -1 /* HOISTED */));
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('first-box box' + ($setup.props.step === 1 ? '-active' : '-done'))
        }, null, 2 /* CLASS */),
        _hoisted_2,
        _hoisted_3,
        _hoisted_4,
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('second-box box' + ($setup.props.step === 2 ? '-active' : $setup.props.step > 2 ? '-done' : ''))
        }, null, 2 /* CLASS */),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('second-number number' + ($setup.props.step >= 2 ? '-active' : ''))
        }, "2", 2 /* CLASS */),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('second-text text' + ($setup.props.step >= 2 ? '-active' : ''))
        }, "Asset Selection", 2 /* CLASS */),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('second-line line' + ($setup.props.step >= 2 ? '-active' : ''))
        }, null, 2 /* CLASS */),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('third-box box' + ($setup.props.step === 3 ? '-active' : ''))
        }, null, 2 /* CLASS */),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('third-number number' + ($setup.props.step === 3 ? '-active' : ''))
        }, "3", 2 /* CLASS */),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
            class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('third-text text' + ($setup.props.step === 3 ? '-active' : ''))
        }, "Summary", 2 /* CLASS */)
    ]));
}
...
const _hoisted_1 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", { class: "select-text" }, "Select assets", -1 /* HOISTED */));
const _hoisted_2 = { class: "treeviewCard" };
const _hoisted_3 = {
    key: 0,
    class: "mdi mdi-application module-color icon-position"
};
const _hoisted_4 = {
    key: 1,
...
const _hoisted_6 = {
    key: 3,
    class: "mdi mdi-palette yaml-color icon-position"
};
const _hoisted_7 = {
    key: 4,
    class: "mdi mdi-palette js-color icon-position"
};
const _hoisted_8 = {
    key: 5,
...
const _hoisted_12 = { class: "pencilIcon" };
const _hoisted_13 = { class: "align-version tree-text ps-3 versionText" };
const _hoisted_14 = {
    key: 0,
...
const _hoisted_17 = { class: "selected-items-count" };
const _hoisted_18 = /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" (");
const _hoisted_19 = { class: "selected-items-count-bold" };
const _hoisted_20 = /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" of ");
const _hoisted_21 = { class: "selected-items-count-bold" };
const _hoisted_22 = /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" models selected) ");
function render(_ctx, _cache, $props, $setup, $data, $options) {
                    ...
                    (node.version != undefined)
                        ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_11, [
                            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [
                                (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h6", _hoisted_13, [
                        ...
                        : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true),
                    (node.type == 'module' || node.type == 'application')
                        ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_16, [
                            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_17, [
                                _hoisted_18,
                                (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(node.children.filter((children) => $setup.treeViewNodes[children].state.checked).length), 1 /* TEXT */),
                                _hoisted_20,
                                (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(node.children.length), 1 /* TEXT */),
                                _hoisted_22
                            ])
                        ]))
                        : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)
...
const _hoisted_1 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", { class: "select-text" }, "Select modules to deploy", -1 /* HOISTED */));
const _hoisted_2 = { class: "top-text" };
const _hoisted_3 = { class: "bold-number" };
const _hoisted_4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    class: "top-text-description",
    style: { "color": "#616161" }
}, " of ", -1 /* HOISTED */));
const _hoisted_5 = { class: "bold-number" };
const _hoisted_6 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", { class: "top-text-description" }, " modules selected", -1 /* HOISTED */));
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [
        _hoisted_1,
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [
            ($setup.enabledModules.length === $setup.checkedModules.length)
                ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
                    key: 0,
                    class: "select-modules-checkbox mdi mdi-minus-box mdi-24px me-2 mb-1 ms-0",
            ...
            ($setup.enabledModules.length !== $setup.checkedModules.length)
                ...
                : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true),
            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.checkedModules.length), 1 /* TEXT */),
            _hoisted_4,
            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.items.length), 1 /* TEXT */),
            _hoisted_6
        ]),
                ...
                (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["tree"], {
                    ...
                    "before-input": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(({ node }) => [
                        (node.type == 'module')
                            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
                                key: 0,
                                class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('mdi mdi-puzzle module-color icon-position' + (node.state.disabled ? ' deploy-screen-disabled-icon' : ''))
                            }, null, 2 /* CLASS */))
                            : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
                                key: 1,
                                class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('mdi mdi-application module-color icon-position' + (node.state.disabled ? ' deploy-screen-disabled-icon' : ''))
                            }, null, 2 /* CLASS */))
                    ]),
                    "after-input": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(({ node }) => [
                        (node.state.disabled)
                            ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_9, "(Deploy Settings is not provided!)"))
                            : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)
                    ]),
                    _: 1 /* STABLE */
                }, 8 /* PROPS */, ["nodes", "config"])
...
const _hoisted_7 = {
    key: 3,
    class: "mdi mdi-palette yaml-color"
};
const _hoisted_8 = {
    key: 4,
    class: "mdi mdi-palette js-color"
};
const _hoisted_9 = {
    key: 5,
