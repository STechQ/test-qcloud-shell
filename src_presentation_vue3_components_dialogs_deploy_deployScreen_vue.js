...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.top-text[data-v-879ea282] {\n    display: flex;\n    margin-top: 38px;\n    margin-left: 37px;\n    align-items: center;\n}\n.treeviewCard[data-v-879ea282] {\n    margin-left: 37px;\n    margin-right: 37px;\n    margin-bottom: 37px;\n    text-align: center;\n    width: 1293px;\n    height: 392px;\n    border: 1px solid #d5d5d5;\n    overflow: auto;\n}\n.qjson-color[data-v-879ea282] {\n    color: #449dd1;\n}\n.process-color[data-v-879ea282] {\n    color: #007c77;\n}\n.bpmn-color[data-v-879ea282] {\n    color: #007c77;\n}\n.entity-designer-color[data-v-879ea282] {\n    color: #e9724c;\n}\n", "",{"version":3,"sources":["webpack://./src/presentation/vue3/components/dialogs/deploy/tabs/summaryTab.vue"],"names":[],"mappings":";AAoGA;IACI,aAAa;IACb,gBAAgB;IAChB,iBAAiB;IACjB,mBAAmB;AACvB;AAEA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,mBAAmB;IACnB,kBAAkB;IAClB,aAAa;IACb,aAAa;IACb,yBAAyB;IACzB,cAAc;AAClB;AACA;IACI,cAAc;AAClB;AAEA;IACI,cAAc;AAClB;AAEA;IACI,cAAc;AAClB;AAEA;IACI,cAAc;AAClB","sourcesContent":["<template>\n    <div class=\"top-text\">\n        <h5 id=\"selectedModuleNumb\">{{ checkedItems.length }}</h5>\n        <h6 class=\"ms-2 me-2\" style=\"color: #616161\">of</h6>\n        <h5 class=\"me-2\">{{ checkedItems.length }}</h5>\n        <h6 style=\"color: #616161\">assets selected</h6>\n    </div>\n    <div style=\"display: flex\">\n        <div class=\"treeviewCard\">\n            <tree :nodes=\"treeViewNodes\" :config=\"config\" @nodeChecked=\"setSelectedModules\" @nodeUnchecked=\"setSelectedModules\">\n                <template #before-input=\"{ node }\">\n                    <span v-if=\"node.type == 'module'\" class=\"mdi mdi-puzzle module-color\" />\n                    <span v-if=\"node.type == 'qjson'\" class=\"mdi mdi-palette qjson-color\" />\n                    <span v-if=\"node.type == 'process'\" class=\"mdi mdi-auto-fix process-color\" />\n                    <span v-if=\"node.type == 'bpmn'\" class=\"mdi mdi-vector-polyline bpmn-color\" />\n                    <span v-if=\"node.type == 'entityDesigner'\" class=\"mdi mdi-database entity-designer-color\" />\n                </template>\n            </tree>\n        </div>\n    </div>\n</template>\n\n<script setup lang=\"ts\">\nimport tree from \"vue3-treeview\";\nimport \"vue3-treeview/dist/style.css\";\nimport { computed, ref } from \"vue\";\nimport { IModule, IItemType } from \"../../../../../../domain/model/models\";\nimport IDeployScreenProps from \"../../../../../../domain/presentation/dialogs/IDeployScreenProps\";\n\ninterface IData {\n    deployScreenProps: IDeployScreenProps;\n}\n\ninterface ITreeViewNode {\n    id: string;\n    text: string;\n    name: string;\n    type: IItemType;\n    state: { checked: boolean };\n    children?: Array<any>;\n}\n\ntype ITreeViewData = Record<string, ITreeViewNode>;\nconst props = defineProps<IData>();\nconst modules = ref<Array<IModule>>(props.deployScreenProps.selectedModules);\nconst roots = modules.value.map((item) => item.ID);\nconst treeViewNodes = ref<ITreeViewData>({});\n\nfunction iterateItemsAndFindChildren(items: Array<any>, path: string) {\n    items.forEach((item) => {\n        console.log(item);\n        const curNode: ITreeViewNode = (treeViewNodes.value[item.ID] = {\n            id: item.ID,\n            text: item.name,\n            name: item.name,\n            type: item.modelType || item.objectType,\n            state: { checked: true },\n        });\n        if (!item.children) {\n            return;\n        }\n\n        curNode.children = item.children.map((child: any) => child.ID);\n        iterateItemsAndFindChildren(item.children, path + \"/\" + item.name);\n    });\n}\n\niterateItemsAndFindChildren(modules.value, \"\");\n\nconst checkedItems = computed(() =>\n    Object.keys(treeViewNodes.value)\n        .map((key) => treeViewNodes.value[key])\n        .filter((item) => item.state.checked)\n);\n\nconst config = ref({\n    roots,\n    checkboxes: false,\n    dragAndDrop: false,\n    editable: false,\n    checkMode: 0,\n});\n\nfunction setSelectedModules() {\n    props.deployScreenProps.selectedModules = modules.value.filter((module) =>\n        checkedItems.value.some((checkedItem) => checkedItem.id === module.ID && checkedItem.state.checked)\n    );\n    props.deployScreenProps.stepper.isTabValid = !!props.deployScreenProps.selectedModules.length;\n    //props.deployScreenProps.stepper.step++;\n}\n\nsetSelectedModules();\n\nfunction setAllCheckStatus(selected: boolean) {\n    Object.keys(treeViewNodes.value).forEach((key) => (treeViewNodes.value[key].state.checked = selected));\n    setSelectedModules();\n}\n</script>\n\n<style scoped>\n.top-text {\n    display: flex;\n    margin-top: 38px;\n    margin-left: 37px;\n    align-items: center;\n}\n\n.treeviewCard {\n    margin-left: 37px;\n    margin-right: 37px;\n    margin-bottom: 37px;\n    text-align: center;\n    width: 1293px;\n    height: 392px;\n    border: 1px solid #d5d5d5;\n    overflow: auto;\n}\n.qjson-color {\n    color: #449dd1;\n}\n\n.process-color {\n    color: #007c77;\n}\n\n.bpmn-color {\n    color: #007c77;\n}\n\n.entity-designer-color {\n    color: #e9724c;\n}\n</style>\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose }) {
        expose();
        const props = __props;
        const modules = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.deployScreenProps.selectedModules);
        const roots = modules.value.map((item) => item.ID);
        const treeViewNodes = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)({});
        function iterateItemsAndFindChildren(items, path) {
            items.forEach((item) => {
        ...
        iterateItemsAndFindChildren(modules.value, "");
        const checkedItems = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => Object.keys(treeViewNodes.value)
            .map((key) => treeViewNodes.value[key])
            .filter((item) => item.state.checked));
        const config = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)({
            roots,
        ...
        function setSelectedModules() {
            props.deployScreenProps.selectedModules = modules.value.filter((module) => checkedItems.value.some((checkedItem) => checkedItem.id === module.ID && checkedItem.state.checked));
            props.deployScreenProps.stepper.isTabValid = !!props.deployScreenProps.selectedModules.length;
            //props.deployScreenProps.stepper.step++;
        }
        setSelectedModules();
        ...
        const __returned__ = { props, modules, roots, treeViewNodes, iterateItemsAndFindChildren, checkedItems, config, setSelectedModules, setAllCheckStatus, tree: vue3_treeview__WEBPACK_IMPORTED_MODULE_1__["default"] };
        Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
        return __returned__;
    }
}));
...
const _hoisted_1 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", { class: "top-text" }, "Select assets ", -1 /* HOISTED */));
...
const _hoisted_4 = { class: "me-2" };
const _hoisted_5 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h6", { style: { "color": "#616161" } }, "assets selected", -1 /* HOISTED */));
const _hoisted_6 = { style: { "display": "flex" } };
const _hoisted_7 = { class: "treeviewCard" };
const _hoisted_8 = {
    key: 0,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [
            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", _hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.checkedItems.length), 1 /* TEXT */),
            _hoisted_3,
            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", _hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.checkedItems.length), 1 /* TEXT */),
            _hoisted_5
        ]),
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [
            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [
