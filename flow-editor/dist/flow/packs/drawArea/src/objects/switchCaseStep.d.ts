...
export declare class SwitchCaseStep extends FlowObjectBase {
    readonly stepName: string;
    private readonly rectangle;
    private readonly text;
    private readonly borderLeft;
    private outputs;
    private inputs;
    private inputConns;
    private outputConns;
    ...
    setSwimlaneId(swimlaneId: string | undefined): void;
    mouseDown(surfacePoint: IPoint): MouseDownReturn;
    protected createSelectionOverlay(): RoundedRectangle[];
...
export {};
//# sourceMappingURL=switchCaseStep.d.ts.map