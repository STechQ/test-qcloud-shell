...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose, emit }) {
        ...
        function checkoutItem(createdModel) {
            executor.execute(async () => { await studio.checkout(createdModel); }, { loading: true });
        }
        const __returned__ = { props, viewModel, executor, dialog, studio, processEditorUtil, emit, isModule, isFolder, isModel, name, description, isEntity, isScreen, isProcess, isProcessDiagram, isEmptyPage, isQuickComponent, isQuickTemplate, isImportFromFile, isGenerateFromEntity, createButtonVisibility, processNameErrorLabel, entities, generateScreenTypes, selectedEntity, selectedGenerateScreenType, create, setAllSubRadiosFalse, onTypeSelect, upload, handleProcessName, checkoutItem };
...
const _hoisted_17 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h6", null, "Name", -1 /* HOISTED */));
const _hoisted_18 = { key: 5 };
const _hoisted_19 = { class: "createButtonDiv" };
